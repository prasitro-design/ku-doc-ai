...
def render_internal_tab():
    ...
    raw_content = st.text_area(
        "เล่ามาแบบภาษาพูดได้เลย ระบบจะเรียบเรียงเป็นภาษาราชการให้",
        height=200,
        placeholder="เช่น ชมรมอยากจัดค่ายอาสาที่จังหวัดน่าน วันที่ 10-12 มกราคม 2569 "
                    "มีนิสิตเข้าร่วม 40 คน ขอใช้รถตู้ 2 คัน และขออนุมัติงบ 25,000 บาท",
        key="in_raw",
    )
...
def render_external_tab():
    ...
    st.divider()
    raw_content = st.text_area(
        "เนื้อหาที่ต้องการสื่อสาร",
        height=200,
        placeholder="เช่น ขอเชิญวิทยากรมาบรรยายหัวข้อการพัฒนาทักษะผู้นำ "
                    "วันที่ 5 กุมภาพันธ์ 2569 เวลา 09.00-12.00 น. ที่ห้องประชุมคณะศึกษาศาสตร์",
        key="ex_raw",
    )
