...
def render_dynamic_form():
    ...
    if doc_type == "[1] ขอความอนุเคราะห์ต่าง ๆ":
        data['subject'] = st.text_input("1. เรื่องที่นิสิตจะขอความอนุเคราะห์คือเรื่องอะไรครับ?", placeholder="ขอความอนุเคราะห์ใช้สถานที่, ขอความอนุเคราะห์ยืมอุปกรณ์,ขอความอนุเคราะห์ลงนามในหนังสือ, ขอลาเรียนโดยไม่ถือเป็นวันลา")
        data['receiver'] = st.text_input("2. หนังสือฉบับนี้เรียนใครครับ? (ตำแหน่งผู้รับ)")
        data['project_name'] = st.text_input("3. ชื่อโครงการอะไรครับ?")
